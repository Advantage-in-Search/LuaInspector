...
tbl.checkSupportedFeatures=newcclosure(function()
    ...
    local supportedFeatures = {
        ...
        readfile = readfile or read_file or "readfile not found",
        loadfile = loadfile or load_file or (readfile and function(filePath) return loadstring(readfile(filePath)) end) or "loadfile not found",
